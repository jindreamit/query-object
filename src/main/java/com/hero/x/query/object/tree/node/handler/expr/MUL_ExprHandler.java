...
public class MUL_ExprHandler implements IExprHandler
{
    @Override
    public void apply(ExprNode exprNode, Context context, WrappedObject wrappedObject)
    {
        ...
        Object result = CalculateUtil.calculateAndPreserveType(currentValue, exprNode.getValue(), BigDecimal::multiply);
